Wire the editor home sidebar and dialogs to the real project APIs.

## Data Fetching

The editor home page is a server component.

Fetch owned and shared projectst server-side using the existing project data helper and pass both lists to the sidebar.
...
- rename dialog pre-fills currrent name
